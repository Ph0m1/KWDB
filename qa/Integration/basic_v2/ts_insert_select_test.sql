...
-- return error: insert time series data into relational table is not supported
insert into test.test2(col1, col3, col5) select e1, e3, e5 from test_ts.ts_table;
