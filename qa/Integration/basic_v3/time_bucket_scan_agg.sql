...
-- Test for var_samp()
SELECT var_samp(value) FROM test_data GROUP BY group_id;

-- Test for var_pop()
SELECT var_pop(value) FROM test_data GROUP BY group_id;

-- Test for quantile()
SELECT quantile(value, 0.5) FROM test_data GROUP BY group_id;
