...
ENUM_MEM(RWLATCH_ID_MMAP_DEL_ITEM_RWLOCK),            \
ENUM_MEM(RWLATCH_ID_MMAP_DEL_ITEM_MGR_RWLOCK),        \
ENUM_MEM(RWLATCH_ID_MMAP_PARTITION_META_RWLOCK),      \
...
ENUM_MEM(RWLATCH_ID_METRIC_VERSION_RWLOCK),           \
ENUM_MEM(RWLATCH_ID_TAG_TABLE_VERSION_MGR_RWLOCK),    \
ENUM_MEM(RWLATCH_ID_TAG_TABLE_PARTITION_MGR_RWLOCK),  \
ENUM_MEM(RWLATCH_ID_LAST_RWLATCH),                    \
ENUM_MEM(RWLATCH_ID_NTAG_INDEXES_RWLATCH),            \
ENUM_MEM(RWLATCH_ID_SCHEMA_MGRS_RWLOCK),              \
ENUM_MEM(RWLATCH_ID_VERSION_CONV_RWLOCK),             \
ENUM_MEM(RWLATCH_ID_WRITE_BATCH_DATA_JOB_RWLOCK),     \
ENUM_MEM(RWLATCH_ID_READ_BATCH_DATA_JOB_RWLOCK),      \
ENUM_MEM(RWLATCH_ID_ENGINE_INSERT_TAG_RWLOCK),        \
ENUM_MEM(RWLATCH_ID_TABLE_VERSION_RWLOCK),            \
ENUM_MEM(RWLATCH_ID_ENTITY_BLOCK_RWLOCK),             \
ENUM_MEM(RWLATCH_ID_ENTITY_BLOCKS_RWLOCK),            \
