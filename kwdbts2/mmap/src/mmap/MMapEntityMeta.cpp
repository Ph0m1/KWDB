...
MMapEntityMeta::MMapEntityMeta(): MMapFile() {
...
MMapEntityMeta::MMapEntityMeta(bool is_et, bool first_meta): MMapFile() {
  is_et_ = is_et;
...
int MMapEntityMeta::open(const string &file_path, const std::string &db_path, const string &tbl_sub_path,
...
int MMapEntityMeta::incSize_(size_t len) {
...
void MMapEntityMeta::to_string(uint entity_id) {
  assert(entity_id > 0);
...
int MMapEntityMeta::GetBlockItem(uint meta_block_id, uint item_id, BlockItem* blk_item) {
