...
/**
 * @brief  MMapEntityMeta used for managing entity metas for current partition.
 *          EntityMetaManager is managing MMapEntityMeta objects.
*/
class MMapEntityMeta: public MMapFile {
  friend class EntityMetaManager;
 private:
 ...
 public:
  MMapEntityMeta();
  MMapEntityMeta(bool is_et, bool first_meta);
  virtual ~MMapEntityMeta();

  int open(const string &file_path, const std::string &db_path, const string &tbl_sub_path, int flags,
