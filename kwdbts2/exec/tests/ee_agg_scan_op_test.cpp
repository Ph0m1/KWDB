...
const int row_num_per_payload = 10;
const int insert_batch = 10;
const int test_table_id = 800;

class TestAggScanOp : public OperatorTestBase {
 public:
  TestAggScanOp() : OperatorTestBase(test_table_id) {
...
//      KTimestamp start_ts = 0;
      auto data_value = TSBSSchema::genPayloadData(ctx_, row_num_per_payload, p_len, start_ts, meta, false);
...
TEST_F(TestAggScanOp, TestDmlExecAgg) {
  TSFlowSpec flow;
