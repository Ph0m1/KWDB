...
var tpccMeta = workload.Meta{
	...
	New: func() workload.Generator {
		...
		g.flags.BoolVar(&g.fks, `fks`, false, `Add the foreign keys`)
		...
		g.flags.StringSliceVar(&g.zoneCfg.zones, "zones", []string{}, "Zones for partitioning, the number of zones should match the number of partitions and the zones used to start kwbase.")
