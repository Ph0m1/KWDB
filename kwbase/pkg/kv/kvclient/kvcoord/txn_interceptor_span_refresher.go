...
func (sr *txnSpanRefresher) maybeRetrySend(
	...
	if ba.Txn.WriteKeyCount < retryTxn.WriteKeyCount {
		ba.Txn.WriteKeyCount = retryTxn.WriteKeyCount
	}
	if ba.Txn.BatchWriteKeyCount < retryTxn.BatchWriteKeyCount {
		ba.Txn.BatchWriteKeyCount = retryTxn.BatchWriteKeyCount
	}
...
func (sr *txnSpanRefresher) splitEndTxnAndRetrySend(
	...
	baSuffix.Txn.WriteKeyCount = ba.Txn.WriteKeyCount
	baSuffix.Txn.BatchWriteKeyCount = ba.Txn.BatchWriteKeyCount
