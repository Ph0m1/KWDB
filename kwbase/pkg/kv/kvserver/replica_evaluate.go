...
// evaluateTSCommand the time series replica no longer calls the processing
// method corresponding to Request for pre-write operations
func evaluateTSCommand(
	ctx context.Context,
