...
func TestRejectFutureCommand(t *testing.T) { ///
	...
	if !testutils.IsPError(pErr, "remote wall time is too far ahead") {
		t.Skipf("unexpected error %v", pErr)
	}
...
//     operation, and kwbase doesn't update its timestamp cache.
...
//func TestAdminSplitForTsRequest(t *testing.T) {
//	defer leaktest.AfterTest(t)()
...
//
//	// Init test ranges:
//	// ["","1000"), ["1000","2000"), ["2000","3000"), ["3000","4000") and ["4000","\xff\xff").
//	ks := []int32{1000, 2000, 4000, 3000}
//	for _, k := range ks {
//		splits := &roachpb.AdminSplitForTsRequest{
//			RequestHeader: roachpb.RequestHeader{
//				Key: sqlbase.MakeTsHashPointKey(sqlbase.ID(100), uint64(k)),
//			},
//			TableId: 100,
//			Keys:    []int32{k},
//		}
//
//		_, pErr := kv.SendWrapped(context.Background(), store.TestSender(), splits)
//		if pErr != nil {
//			t.Fatalf("split unexpected error: %s", pErr)
//		}
//	}
//
//	// Resolve the intents.
...
//		{
//			key: roachpb.RKey(sqlbase.MakeTsHashPointKey(sqlbase.ID(100), uint64(1001))),
//			// ["1000","2000")
//			expected: roachpb.RangeDescriptor{
//				StartKey:  roachpb.RKey(sqlbase.MakeTsHashPointKey(sqlbase.ID(100), uint64(1000))),
//				EndKey:    roachpb.RKey(sqlbase.MakeTsHashPointKey(sqlbase.ID(100), uint64(2000))),
//				RangeType: &TsRange,
//			},
//		},
//		{
//			key: roachpb.RKey(sqlbase.MakeTsHashPointKey(sqlbase.ID(100), uint64(2999))),
//			// ["2000","3000")
//			expected: roachpb.RangeDescriptor{
//				StartKey:  roachpb.RKey(sqlbase.MakeTsHashPointKey(sqlbase.ID(100), uint64(2000))),
//				EndKey:    roachpb.RKey(sqlbase.MakeTsHashPointKey(sqlbase.ID(100), uint64(3000))),
//				RangeType: &TsRange,
//			},
//		},
//	}
...
//			rs, _, err := kv.RangeLookup(context.Background(), store.TestSender(),
//				test.key.AsRawKey(), roachpb.READ_UNCOMMITTED, 0, true /* prefetchReverse */)
//			if err != nil {
//				t.Fatalf("LookupRange error: %+v", err)
//			}
//
//			rangeDesc := rs[0]
//			if !(rangeDesc.StartKey.Equal(test.expected.StartKey) && rangeDesc.EndKey.Equal(test.expected.EndKey)) {
//				t.Fatalf("returned range is not correct, expected %v, but got %v", rangeDesc, test.expected)
//			}
//
//			if rangeDesc.GetRangeType() != *test.expected.RangeType {
//				t.Fatalf("TS Range RangeType info error: %+v", rangeDesc.RangeType)
//			}
//
//			for _, r := range rangeDesc.InternalReplicas {
//				if r.GetTag() != roachpb.TS_REPLICA {
//					t.Fatalf("TS Range replica tag info error: %+v", r.GetTag())
//				}
//			}
//		})
//	}
...
func TestSystemZoneConfigs(t *testing.T) {
	defer leaktest.AfterTest(t)()
	t.Skip("The related feature has been disabled.")
...
//
// See https://gitee.com/kwbasedb/kwbase/issues/40877.
...
func TestStrictGCEnforcement(t *testing.T) {
	...
	var (
		...
		getTableID = func() (tableID uint32) {
			sqlDB.QueryRow(t, `SELECT table_id FROM kwdb_internal.tables`+
