...
var (
	...
	tsdbUsed = metric.Metadata{
		Name:        "capacity.tsdb_used",
		Help:        "TSDB used storage capacity",
		Measurement: "Storage",
		Unit:        metric.Unit_BYTES,
	}
	relationalUsed = metric.Metadata{
		Name:        "capacity.relational_used",
		Help:        "Relational used storage capacity",
		Measurement: "Storage",
		Unit:        metric.Unit_BYTES,
	}
...
type StoreMetrics struct {
	...
	TsdbUsed           *metric.Gauge
	RelationalUsed     *metric.Gauge
...
func newStoreMetrics(histogramWindow time.Duration) *StoreMetrics {
	...
	sm := &StoreMetrics{
		...
		TsdbUsed:       metric.NewGauge(tsdbUsed),
		RelationalUsed: metric.NewGauge(relationalUsed),
