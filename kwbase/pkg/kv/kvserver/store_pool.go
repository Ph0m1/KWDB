...
func LivenessStatus(
	...
	if l.Upgrading {
		...
		return storagepb.NodeLivenessStatus_UPGRADING
	}
	if l.IsDead(now, deadThreshold) {
...
func (sd *storeDetail) status(
	...
	case storagepb.NodeLivenessStatus_UNKNOWN, storagepb.NodeLivenessStatus_UNAVAILABLE, storagepb.NodeLivenessStatus_UPGRADING:
		return storeStatusUnknown
	}
...
func (sp *StorePool) getStoreDescriptorAddress(
