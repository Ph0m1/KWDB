...
var testingDisableQuiescence = envutil.EnvOrDefaultBool("KWBASE_DISABLE_QUIESCENCE", false)
...
type Replica struct {
	...
	rangeFeedSplitOrMergeRegisterMu struct {
		syncutil.RWMutex
		preRspan        []interval.Range
		rangeFeedbuffer []enginepb.MVCCLogicalOp
		splitMergeSig   RegisterState
		notFirst        bool
	}
