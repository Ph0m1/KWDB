...
// IsZoneConfigForTsRange check if zone config for ts range.
func (z *ZoneConfig) IsZoneConfigForTsRange() bool {
	return len(z.Constraints) != 0 || len(z.LeasePreferences) != 0
}
