...
func (t *MVCCValueMerger) Finish() ([]byte, error) {
	...
	// TODO(ajkr): confirm it is the case that (1) today's KWDB always merges timeseries
	// values in columnar format, and (2) today's KWDB does not need to be downgrade-
