...
func TestMVCCStatsDeleteMovesTimestamp(t *testing.T) {
	...
	for _, engineImpl := range mvccEngineImpls {
		t.Run(engineImpl.name, func(t *testing.T) {
			...
			require.EqualValues(t, mVal1Size, 48)
			...
			require.EqualValues(t, m1ValSize, 48)
			...
			require.EqualValues(t, m2ValSize, 66)
...
func TestMVCCStatsPutMovesDeletionTimestamp(t *testing.T) {
	...
	for _, engineImpl := range mvccEngineImpls {
		t.Run(engineImpl.name, func(t *testing.T) {
			...
			require.EqualValues(t, m2ValSize, 56)
...
func TestMVCCStatsDelDelCommitMovesTimestamp(t *testing.T) {
	...
	for _, engineImpl := range mvccEngineImpls {
		t.Run(engineImpl.name, func(t *testing.T) {
			...
			require.EqualValues(t, mValSize, 48)
...
func TestMVCCStatsPutDelPutMovesTimestamp(t *testing.T) {
	...
	for _, engineImpl := range mvccEngineImpls {
		t.Run(engineImpl.name, func(t *testing.T) {
			...
			require.EqualValues(t, m2ValSize, 50)
			...
			t.Run("Put", func(t *testing.T) {
				...
				require.EqualValues(t, m2ValSizeWithHistory, 56)
...
func TestMVCCStatsTxnSysPutPut(t *testing.T) {
	...
	for _, engineImpl := range mvccEngineImpls {
		t.Run(engineImpl.name, func(t *testing.T) {
			...
			require.EqualValues(t, mVal2Size, 66)
