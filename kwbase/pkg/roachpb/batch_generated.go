...
func (ru ErrorDetail) GetInner() error {
	...
	case *ErrorDetail_DefaultReplicaReceiveTsRequest:
		return t.DefaultReplicaReceiveTsRequest
	case *ErrorDetail_LeaseHolderExpired:
		return t.LeaseHolderExpired
	default:
		return nil
	}
}
...
func (ru RequestUnion) GetInner() Request {
	...
	case *RequestUnion_AdminSplit:
		return t.AdminSplit
	case *RequestUnion_AdminSplitForTs:
...
func (ru *ErrorDetail) SetInner(r error) bool {
	...
	case *DefaultReplicaReceiveTSRequestError:
		union = &ErrorDetail_DefaultReplicaReceiveTsRequest{t}
	case *LeaseHolderExpiredError:
		union = &ErrorDetail_LeaseHolderExpired{t}
	default:
		return false
	}
	ru.Value = union
...
func (ru *RequestUnion) SetInner(r Request) bool {
	...
	case *AdminSplitForTsRequest:
		union = &RequestUnion_AdminSplitForTs{t}
...
type tsPutResponseAlloc struct {
...
type tsDeleteResponseAlloc struct {
	...
	resp  TsDeleteResponse
}
type tsDeleteEntityResponseAlloc struct {
	union ResponseUnion_TsDeleteEntity
	resp  TsDeleteEntityResponse
}
type getReplicaStatusResponseAlloc struct {
...
func (ba *BatchRequest) CreateReply() *BatchResponse {
	...
	var buf11 []adminSplitForTsResponseAlloc
	...
	for i, r := range ba.Requests {
		...
		case *RequestUnion_AdminSplitForTs:
			if buf11 == nil {
				buf11 = make([]adminSplitForTsResponseAlloc, counts[11])
			}
			buf11[0].union.AdminSplitForTs = &buf11[0].resp
		...
		case *RequestUnion_TsPut:
			if buf45 == nil {
				buf45 = make([]tsPutResponseAlloc, counts[45])
			}
