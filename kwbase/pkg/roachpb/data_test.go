...
import (
	...
	"gitee.com/kwbasedb/kwbase/pkg/testutils/zerofields"
...
func TestTransactionUpdate(t *testing.T) {
	...
	expTxn3 := txn
	expTxn3.Name = "carl"
	txn3.BatchWriteKeyCount = 1
	txn3.WriteKeyCount = 1
	...
	txn4.WriteKeyCount = 1
	txn4.UnConsistency = true
	expTxn4 := txn
	expTxn4.Name = "carl"
...
func TestValuePrettyPrint(t *testing.T) {
	...
	tests := []struct {
		...
		{durationValue, "/DURATION/1 mon 2 days 00:00:00.000000003+3ns"},
