...
var (
	...
	// implemented in package git.com/kwbasedb/kwbase/keys to avoid
...
// IsNotEmpty returns true if ChildNameKeys's length is not 0.
func (ce ChildEntries) IsNotEmpty() bool {
	return len(ce.ChildNameKeys) != 0
}
