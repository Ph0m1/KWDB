...
func initColumnItemResolverTester(t *testing.T, ct ColumnItemResolverTester) {
	ct.AddTable(tree.MakeTableNameWithSchema("", "kwdb_internal", "tables"), []tree.Name{"table_name"})
...
func RunResolveColumnItemTest(t *testing.T, ct ColumnItemResolverTester) {
	testCases := []struct {
		...
		{`k`, `db1.public.kv.k`, ``},
		{`v`, `db1.public.kv.v`, ``},
		{`table_name`, `"".kwdb_internal.tables.table_name`, ``},
		...
		{`bar.x`, `bar.x`, ``},
		{`tables.table_name`, `"".kwdb_internal.tables.table_name`, ``},

		{`a.b.x`, ``, `no data source matches prefix: a\.b`},
		{`kwdb_internal.tables.table_name`, `"".kwdb_internal.tables.table_name`, ``},
