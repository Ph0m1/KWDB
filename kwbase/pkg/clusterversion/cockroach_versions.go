...
var versionsSingleton = keyedVersions([]keyedVersion{
	//{
	// Removed
	// VersionUnreplicatedRaftTruncatedState is https://gitee.com/kwbasedb/kwbase/pull/34660.
	...
	// Removed.
	// {
	// 	// VersionQueryTxnTimestamp is https://gitee.com/kwbasedb/kwbase/pull/36307.
	// 	Key:     VersionQueryTxnTimestamp,
	// 	Version: roachpb.Version{Major: 19, Minor: 1, Unstable: 2},
	// },
	// Removed.
	// {
	// 	// VersionStickyBit is https://gitee.com/kwbasedb/kwbase/pull/37506.
	// 	Key:     VersionStickyBit,
	// 	Version: roachpb.Version{Major: 19, Minor: 1, Unstable: 3},
	// },
	// Removed.
	// {
	// 	// VersionParallelCommits is https://gitee.com/kwbasedb/kwbase/pull/37777.
	// 	Key:     VersionParallelCommits,
	// 	Version: roachpb.Version{Major: 19, Minor: 1, Unstable: 4},
	// },
	// Removed.
	// {
	// 	// VersionGenerationComparable is https://gitee.com/kwbasedb/kwbase/pull/38334.
	// 	Key:     VersionGenerationComparable,
	// 	Version: roachpb.Version{Major: 19, Minor: 1, Unstable: 5},
	// },
	{
		// VersionLearnerReplicas is https://gitee.com/kwbasedb/kwbase/pull/38149.
		Key:     VersionLearnerReplicas,
		Version: roachpb.Version{Major: 19, Minor: 1, Unstable: 6},
	},
	{
		// VersionTopLevelForeignKeys is https://gitee.com/kwbasedb/kwbase/pull/39173.
		//
	...
	{
		// VersionAtomicChangeReplicasTrigger is https://gitee.com/kwbasedb/kwbase/pull/39485.
		//
	...
	{
		// VersionAtomicChangeReplicas is https://gitee.com/kwbasedb/kwbase/pull/39936.
		//
	...
	{
		// VersionTableDescModificationTimeFromMVCC is https://gitee.com/kwbasedb/kwbase/pull/40581
		//
	...
	{
		// VersionPartitionedBackup is https://gitee.com/kwbasedb/kwbase/pull/39250.
	...
	{
		// VersionContainsEstimatesCounter is https://gitee.com/kwbasedb/kwbase/pull/37583.
		//
	...
	{
		// VersionSecondaryIndexColumnFamilies is https://gitee.com/kwbasedb/kwbase/pull/42073.
		//
	...
	{
		// VersionNamespaceTableWithSchemas is https://gitee.com/kwbasedb/kwbase/pull/41977
		//
	...
	{
		// VersionPrimaryKeyChanges is https://gitee.com/kwbasedb/kwbase/pull/42462
		//
	...
	{
		// VersionNoExplicitForeignKeyIndexIDs is https://gitee.com/kwbasedb/kwbase/pull/43332.
		//
	...
	{
		// VersionHashShardedIndexes is https://gitee.com/kwbasedb/kwbase/pull/42922
		//
	...
	{
		// VersionCreateRolePrivilege is https://gitee.com/kwbasedb/kwbase/pull/44232.
		//
	...
	{
		// VersionSchemaChangeJob is https://gitee.com/kwbasedb/kwbase/pull/45870.
		//
