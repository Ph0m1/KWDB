...
var sourceAddr = func() net.Addr {
	const envKey = "KWBASE_SOURCE_IP_ADDRESS"
...
var enableRPCCompression = envutil.EnvOrDefaultBool("KWBASE_ENABLE_RPC_COMPRESSION", true)
...
func (ctx *Context) grpcDialNodeInternal(
	...
	if !ok {
		...
		if remoteNodeID != 0 {
			...
			//
			// See:
			// https://gitee.com/kwbasedb/kwbase/issues/37200
