...
import (
	...
	"gitee.com/kwbasedb/kwbase/pkg/util/keysutil"
...
func TestPrettyPrint(t *testing.T) {
	...
	testCases := []struct {
		...
		{keys.UserTableDataMin, "/Table/75", revertMustSupport},
		...
		{makeKey(keys.MakeTablePrefix(42),
			...
			"/Table/42/-2 mons -2 days +743:59:58.999999999+999ns", revertSupportUnknown},
