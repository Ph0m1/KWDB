...
The Dockerfile in this directory builds an image, `kwbasedb/acceptance`, in
...
```bash
$ docker build -t kwbasedb/acceptance .
```
...
$ docker tag kwbasedb/acceptance kwbasedb/acceptance:$version
$ docker push kwbasedb/acceptance:$version
```
