...
var maxAllocatedButUnusedBlocks = envutil.EnvOrDefaultInt("KWBASE_MAX_ALLOCATED_UNUSED_BLOCKS", 10)

// DefaultPoolAllocationSize specifies the unit of allocation used by a monitor
// to reserve and release bytes to a pool.
var DefaultPoolAllocationSize = envutil.EnvOrDefaultInt64("KWBASE_ALLOCATION_CHUNK_SIZE", 10*1024)
