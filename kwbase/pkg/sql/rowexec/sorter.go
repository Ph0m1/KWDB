...
func (ss *SorterStats) TsStats() map[int32]map[string]string {
	return nil
}
...
func (ss *SorterStats) TsStatsForQueryPlan() map[int32][]string {
	return nil
}
...
func (s *sorterBase) outputStatsToTrace() {
	...
	if sp := opentracing.SpanFromContext(s.PbCtx()); sp != nil {
...
func newSortChunksProcessor(
	...
	proc.i = proc.rows.NewFinalIterator(proc.PbCtx())
	return proc, nil
}
