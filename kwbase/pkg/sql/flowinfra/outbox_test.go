...
func TestOutbox(t *testing.T) {
	...
	replicationID := execinfrapb.StreamID(42)
	outbox := NewOutbox(&flowCtx, execinfra.StaticNodeID, flowID, replicationID)
...
func TestOutboxInitializesStreamBeforeReceivingAnyRows(t *testing.T) {
	...
	if producerMsg.Header.FlowID != flowID || producerMsg.Header.StreamID != replicationID {
