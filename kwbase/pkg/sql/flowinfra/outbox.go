...
func (m *Outbox) mainLoop(ctx context.Context) error {
	...
	ctx, span = execinfra.ProcessorSpan(ctx, "outbox", int32(m.flowCtx.NodeID))
...
func (os *OutboxStats) TsStats() map[int32]map[string]string {
	return nil
}
...
func (os *OutboxStats) TsStatsForQueryPlan() map[int32][]string {
	return nil
}
