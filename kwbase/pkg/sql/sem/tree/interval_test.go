...
func TestPGIntervalSyntax(t *testing.T) {
	...
	testData := []struct {
		...
		{`500nanoseconds`, types.IntervalTypeMetadata{}, `00:00:00.0000005`, ``},
		{`500ns`, types.IntervalTypeMetadata{}, `00:00:00.0000005`, ``},

		// ns/us boundary
		{`.5us`, types.IntervalTypeMetadata{}, `00:00:00.0000005`, ``},
		{`-0.499us`, types.IntervalTypeMetadata{}, `-00:00:00.000000499`, ``},
		{`-0.5us`, types.IntervalTypeMetadata{}, `-00:00:00.0000005`, ``},
		{`0.000000499s`, types.IntervalTypeMetadata{}, `00:00:00.000000499`, ``},
		{`0.0000005s`, types.IntervalTypeMetadata{}, `00:00:00.0000005`, ``},
		{`-0.000000499s`, types.IntervalTypeMetadata{}, `-00:00:00.000000499`, ``},
		{`-0.0000005s`, types.IntervalTypeMetadata{}, `-00:00:00.0000005`, ``},

		{`1.2 microsecond`, types.IntervalTypeMetadata{}, `00:00:00.0000012`, ``},
		{`1.2microseconds`, types.IntervalTypeMetadata{}, `00:00:00.0000012`, ``},
		{`1.2us`, types.IntervalTypeMetadata{}, `00:00:00.0000012`, ``},
		// µ = U+00B5 = micro symbol
		// μ = U+03BC = Greek letter mu
		{`1.2µs`, types.IntervalTypeMetadata{}, `00:00:00.0000012`, ``},
		{`1.2μs`, types.IntervalTypeMetadata{}, `00:00:00.0000012`, ``},
		{`1.2usec`, types.IntervalTypeMetadata{}, `00:00:00.0000012`, ``},
		{`1.2usecs`, types.IntervalTypeMetadata{}, `00:00:00.0000012`, ``},
		{`1.2usecond`, types.IntervalTypeMetadata{}, `00:00:00.0000012`, ``},
		{`1.2useconds`, types.IntervalTypeMetadata{}, `00:00:00.0000012`, ``},
		{`0.23us`, types.IntervalTypeMetadata{}, `00:00:00.00000023`, ``},
		{`-0.23us`, types.IntervalTypeMetadata{}, `-00:00:00.00000023`, ``},
		{`0.2346us`, types.IntervalTypeMetadata{}, `00:00:00.000000234`, ``},
		{`-1.2us`, types.IntervalTypeMetadata{}, `-00:00:00.0000012`, ``},
		...
		{`0.2304506ms`, types.IntervalTypeMetadata{}, `00:00:00.00023045`, ``},
		{`0.0002304506ms`, types.IntervalTypeMetadata{}, `00:00:00.00000023`, ``},
		...
		{`0.2304506708s`, types.IntervalTypeMetadata{}, `00:00:00.23045067`, ``},
		{`0.0002304506708s`, types.IntervalTypeMetadata{}, `00:00:00.00023045`, ``},
		{`0.0000002304506s`, types.IntervalTypeMetadata{}, `00:00:00.00000023`, ``},
		...
		{`0.23045067089m`, types.IntervalTypeMetadata{}, `00:00:13.827040253`, ``},
		{`-0.23045067089m`, types.IntervalTypeMetadata{}, `-00:00:13.827040253`, ``},
		...
		{`0.23045067089h`, types.IntervalTypeMetadata{}, `00:13:49.622415204`, ``},
		{`-0.23045067089h`, types.IntervalTypeMetadata{}, `-00:13:49.622415204`, ``},
		...
		{`1.11mon`, types.IntervalTypeMetadata{}, `1 mon 3 days 07:11:59.999999999`, ``},
		...
		{`1 day 12:30:40.500500001`, types.IntervalTypeMetadata{}, `1 day 12:30:40.500500001`, ``},

		// Regressions

		// This was 1ns off due to float rounding.
		{`50 years 6 mons 75 days 1572897:25:58.535696141`, types.IntervalTypeMetadata{}, `50 years 6 mons 75 days 1572897:25:58.535696141`, ``},
	}
	for _, test := range testData {
		t.Run(test.input, func(t *testing.T) {
