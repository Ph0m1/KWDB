	...
	t.Run("vectorized", func(t *testing.T) {
		walk(t, func(t *testing.T, d *datadriven.TestData) string {
			if d.Input == "B'11111111111111111111111110000101'::int4" {
				// Skip this test: https://gitee.com/kwbasedb/kwbase/pull/40790#issuecomment-532597294.
...
func TestEvalError(t *testing.T) {
	...
	testData := []struct {
		...
		// {`~0 + 1`, `0`},
		{`9223372036854775807::int + 1::int`, `value is out of range for type int4`},
		{`-9223372036854775807::int + -2::int`, `value is out of range for type int4`},
		{`-9223372036854775807::int + -9223372036854775807::int`, `value is out of range for type int4`},
		{`9223372036854775807::int + 9223372036854775807::int`, `value is out of range for type int4`},
		{`9223372036854775807::int - -1::int`, `value is out of range for type int4`},
		{`-9223372036854775807::int - 2::int`, `value is out of range for type int4`},
		{`-9223372036854775807::int - 9223372036854775807::int`, `value is out of range for type int4`},
		{`9223372036854775807::int - -9223372036854775807::int`, `value is out of range for type int4`},
		{`4611686018427387904::int * 2::int`, `value is out of range for type int4`},
		{`4611686018427387904::int * 2::int`, `value is out of range for type int4`},
