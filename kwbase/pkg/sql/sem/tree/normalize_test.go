...
func TestNormalizeExpr(t *testing.T) {
	...
	testData := []struct {
		...
		// https://gitee.com/kwbasedb/kwbase/issues/32639
		{`CAST(NULL AS INT1)`, `CAST(NULL AS INT1)`},
		...
		{`clock_timestamp()`, `clock_timestamp()`},
		{`kwdb_internal.force_error('a', 'b')`, `kwdb_internal.force_error('a', 'b')`},
		{`kwdb_internal.force_panic('a')`, `kwdb_internal.force_panic('a')`},
		{`kwdb_internal.force_log_fatal('a')`, `kwdb_internal.force_log_fatal('a')`},
		{`kwdb_internal.force_retry('1 day'::interval)`, `kwdb_internal.force_retry('1 day')`},
		{`kwdb_internal.no_constant_folding(123)`, `kwdb_internal.no_constant_folding(123)`},
		{`kwdb_internal.set_vmodule('a')`, `kwdb_internal.set_vmodule('a')`},
		{`uuid_v4()`, `uuid_v4()`},
