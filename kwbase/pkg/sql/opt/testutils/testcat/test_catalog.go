...
func (tc *Catalog) nextStableID() cat.StableID {
	...
	// 53 is a magic number derived from how KWDB internally stores tables. The
...
func (s *Schema) GetDatabaseType() tree.EngineType {
	return tree.EngineTypeRelational
}
...
// DeleteTagsFromDesc delete tags from table desc.
func (tt *Table) DeleteTagsFromDesc() {}
...
// GetParentID return parent ID of table.
func (tt *Table) GetParentID() tree.ID {
	return 0
}
