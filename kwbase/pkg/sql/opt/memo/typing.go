...
func init() {
	...
	typingFuncMap[opt.FirstOp] = typeAsFirstArg
	typingFuncMap[opt.FirstRowOp] = typeAsFirstArg
	typingFuncMap[opt.LastOp] = typeAsFirstArg
	typingFuncMap[opt.LastRowOp] = typeAsFirstArg
	...
	typingFuncMap[opt.TimeBucketGapfillOp] = typeAsFirstArg
