...
func init() {
	...
	//funcMap[opt.SynchronizerOp] = funcs{
	//	canProvideOrdering:    synchcronizerCanProvideOrdering,
	//	buildChildReqOrdering: synchronizerBuildChildReqOrdering,
	//	buildProvidedOrdering: synchronizerBuildProvided,
	//}
