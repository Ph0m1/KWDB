...
var InitWhiteList = []sqlbase.WhiteList{
	...
	{"time", 1, []uint32{uint32(oid.T_timestamptz)}, PosWhereAndProject, true, TypeConstAndColumn},
	{"time", 1, []uint32{uint32(oid.T_timestamp)}, PosWhereAndProject, true, TypeConstAndColumn},
	{"time", 1, []uint32{uint32(oid.T_bpchar)}, PosWhereAndProject, true, TypeConstAndColumn},
	{"time", 1, []uint32{uint32(oid.T_varchar)}, PosWhereAndProject, true, TypeConstAndColumn},
	{"time", 1, []uint32{uint32(oid.T_text)}, PosWhereAndProject, true, TypeConstAndColumn},
