...
type RestrictedCommandResult interface {
	...
	// WarningForExport is only to print warning during export
	WarningForExport(err error)
...
// WarningForExport is unimplemented.
func (r *bufferedCommandResult) WarningForExport(err error) {
	panic("unimplemented")
}
...
// AddPGResult is part of the RestrictedCommandResult interface.
...
func (r *bufferedCommandResult) StmtType() tree.StatementType {
	return tree.Ack
}
