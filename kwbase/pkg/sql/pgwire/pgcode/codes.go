...
// external hint err
const (
	// CLASS EB - External Hint Bind Err
	ExternalBindLookupRight = "BJDLKSN"
	ExternalBindUnknowType  = "BAMNTUK"

	ExternalBindNoTable   = "BAMTNUK"
	ExternalBindRealOrder = "BJDJMRJ"

	ExternalBindScanIndex = "BAMSHID"
	ExternalBindJoinIndex = "BJMJHID"

	// CLASS EA - External Hint Apply Err
	ExternalApplyMergeJoin  = "AJMMRLL"
	ExternalApplyLookupJoin = "AJMLKLL"

	ExternalApplyHashJoinDisallow   = "AJMHJDG"
	ExternalApplyMergeJoinDisallow  = "AJMMJDG"
	ExternalApplyLookupJoinDisallow = "AJMLKDG"

	ExternalApplyTableScanUse    = "AAMUTS"
	ExternalApplyTableScanForce  = "AAMFTS"
	ExternalApplyTableScanIgnore = "AAMITS"

	ExternalApplyIndexScanUse    = "AAMUIS"
	ExternalApplyIndexScanForce  = "AAMFIS"
	ExternalApplyIndexScanIgnore = "AAMIIS"

	ExternalApplyIndexOnlyUse    = "AAMUIO"
	ExternalApplyIndexOnlyForce  = "AAMFIO"
	ExternalApplyIndexOnlyIgnore = "AAMIIO"

	ExternalApplyCardinalityScan = "ACDS"
	ExternalApplyCardinalityJoin = "ACDJ"
)
