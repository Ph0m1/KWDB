...
func dropSystemTable(ctx context.Context, r runner) error {
	unusedTable := []string{
		"kwdb_ha_info",
		"kwdb_topic",
		"kwdb_object_relation",
		"kwdb_node_info",
		"kwdb_system_config",
		"kwdb_node_migrate_log",
		"mm_namespace",
		"kwdb_pre_computing",
		"kaiwudb_jobs",
		"ml_jobs",
	...
	for _, table := range unusedTable {
		...
		if err := r.execAsRoot(ctx, "drop unused system table", dropStmt); err != nil {
			return err
		}
	}
	return nil
