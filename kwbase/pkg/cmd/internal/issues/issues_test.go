...
func TestPost(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:        "failure",
			packageName: "gitee.com/kwbasedb/kwbase/pkg/storage",
			...
			t.Run(name, func(t *testing.T) {
				t.Run(c.name, func(t *testing.T) {
					...
					p.createIssue = func(_ context.Context, owner string, repo string,
						...
						t.Log(render)
						_, _ = fmt.Fprintf(&buf, "createIssue owner=%s repo=%s:\n%s\n\n%s\n\n%s\n\nRendered: %s\n", owner, repo, github.Stringify(issue), title, body, render)
...
func TestPostEndToEnd(t *testing.T) {
	...
	env := map[string]string{
		...
		teamcityServerURLEnv:   "https://teamcity.kwbasedb.com",
	...
	// of the kwbasedb/kwbase repo.
	githubUser = "tbg"

	req := PostRequest{
		TitleTemplate: "test issue 2",
		BodyTemplate:  "test body",
		PackageName:   "gitee.com/kwbasedb/kwbase/pkg/foo/bar",
...
func TestInvalidAssignee(t *testing.T) {
	u, err := url.Parse("https://api.github.com/repos/kwbasedb/kwbase/issues")
	if err != nil {
		log.Fatal(err)
	}
...
func ghURL(t *testing.T, title, body string) string {
	u, err := url.Parse("https://gitee.com/kwbasedb/kwbase/issues/new")
