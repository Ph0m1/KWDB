...
import (
	...
	"gitee.com/kwbasedb/kwbase/pkg/cmd/roachprod/vm/flagstub"
...
const (
	defaultProject = "kwbase-ephemeral"
	// ProviderName is gce.
	ProviderName = "gce"
)
...
func (jsonVM *jsonVM) toVM(project string, opts *providerOpts) (ret *vm.VM) {
	...
	//  "https://www.googleapis.com/compute/v1/projects/kwbase-shared/zones/us-east1-b/machineTypes/n1-standard-16"
