...
// See:
// https://gitee.com/kwbasedb/kwbase/issues/33732
// https://gitee.com/kwbasedb/kwbase/issues/33708
// https://github.cm/kwbasedb/kwbase/issues/34012
// https://gitee.com/kwbasedb/kwbase/issues/33683#issuecomment-454889149
...
func IsExpectedRelocateError(err error) bool {
	allowlist := []string{
		...
		"snapshot failed:",
		"breaker open",
		"unable to select removal target", // https://gitee.com/kwbasedb/kwbase/issues/49513
	}
