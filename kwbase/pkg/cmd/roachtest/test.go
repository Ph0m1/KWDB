...
type testSpec struct {
	...
	// MinVersion indicates the minimum kwbase version that is required for
	// the test to be run. If MinVersion is less than the version specified
	// --kwbase-version, Skip will be populated causing the test to be
	// skipped.
	MinVersion string
...
// depending on the kwbase version it is running against. Note that the
