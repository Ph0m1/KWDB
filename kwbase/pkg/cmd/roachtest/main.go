...
func main() {
	...
	var rootCmd = &cobra.Command{
		...
		Short: "roachtest tool for testing kwbase clusters",
		Long: `roachtest is a tool for testing kwbase clusters.
`,
...
`,
	...
	var runCmd = &cobra.Command{
		...
		SilenceUsage: true,
		Use:          "run [tests]",
		Short:        "run automated tests on kwbase cluster",
		Long: `Run automated tests on existing or ephemeral kwbase clusters.
...
`,
	...
	// TODO(irfansharif): We could remove this by directly running `kwbase
	...
	var benchCmd = &cobra.Command{
		...
		Short:        "run automated benchmarks on kwbase cluster",
		Long:         `Run automated benchmarks on existing or ephemeral kwbase clusters.`,
		RunE: func(_ *cobra.Command, args []string) error {
