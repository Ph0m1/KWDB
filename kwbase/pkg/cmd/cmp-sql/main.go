...
// cmp-sql connects to postgres and kwbase servers and compares the
...
//
// To use, start a kwbase and postgres server with SSL disabled. cmp-sql
...
type Input struct {
	...
	// kwdb and pg return non-error results.
