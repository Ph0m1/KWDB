...
var chartCatalog = []ChartSection{
	{
		...
		<code>kwbase</code> process running on this server.`,
		Level: 0,
	},
	{
		Title:           SQLLayer,
	...
	},
	{
		Title:           Audits,
		LongTitle:       Audits,
		CollectionTitle: "audit-all",
		Description:     `The audit provides a server to log all operations `,
		Level:           0,
	},
	{
		Title:           License,
		LongTitle:       License,
		CollectionTitle: "license-all",
		Description:     `The license provides a server to log the metrics relevant to license `,
		Level:           0,
	},
	{
		Title:           Jobs,
