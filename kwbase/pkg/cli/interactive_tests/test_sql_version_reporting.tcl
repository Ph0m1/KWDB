...
set env(KWBASE_TESTING_VERSION_TAG) "v0.1.0-fakever"
start_server $argv
set env(KWBASE_TESTING_VERSION_TAG) "v0.2.0-fakever"
spawn $argv sql
send "select 1;\r"
eexpect "# Client version: KwDB"
eexpect "# Server version: KwDB"
eexpect "fakever"
