...
eexpect "KwDB node starting"
system "$argv sql --insecure -e \"select kwdb_internal.force_log_fatal('helloworld')\" || true"
eexpect "\r\nF"
eexpect "helloworld"
eexpect ":/# "
send "echo \$?\r"
...
send "tail -f logs/db/logs/kwbase.log\r"
...
system "($argv sql --insecure -e \"select kwdb_internal.force_panic('helloworld')\" || true)&"
...
send "cat logs/db/logs/kwbase.log\r"
