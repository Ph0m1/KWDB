...
send "BEGIN; SAVEPOINT kwbase_restart;\r\r"
eexpect SAVEPOINT
eexpect root@
send "SELECT 1;\r"
eexpect "1 row"
eexpect root@
send "RELEASE SAVEPOINT kwbase_restart;\r"
eexpect "\nCOMMIT\r\n"
eexpect root@
eexpect "DONE>"
end_test
...
eexpect SAVEPOINT
eexpect root@
send "SELECT kwdb_internal.force_retry('1s':::INTERVAL);\r"
...
send "ROLLBACK TO SAVEPOINT kwbase_restart;\r"
eexpect ROLLBACK
eexpect root@
eexpect "OPEN>"
end_test
