...
system "grep -q 'initial startup completed' logs/db/logs/kwbase.log"
system "grep -q 'will now attempt to join a running cluster, or wait' logs/db/logs/kwbase.log"
end_test
...
set ::env(KWBASE_CONNECT_TIMEOUT) "1"
spawn /bin/bash
send "PS1=':''/# '\r"
eexpect ":/# "
send "$argv sql\r"
...
set ::env(KWBASE_CONNECT_TIMEOUT) "0"
