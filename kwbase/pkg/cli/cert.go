...
var createCACertCmd = &cobra.Command{
	Use:   "create-ca --certs-dir=<path to kwbase certs dir> --ca-key=<path-to-ca-key>",
...
var createClientCACertCmd = &cobra.Command{
	Use:   "create-client-ca --certs-dir=<path to kwbase certs dir> --ca-key=<path-to-client-ca-key>",
...
If the client CA exists, a client.node.crt client certificate must be created using:
  kwbase cert create-client node
...
var createNodeCertCmd = &cobra.Command{
	Use:   "create-node --certs-dir=<path to kwbase certs dir> --ca-key=<path-to-ca-key> <host 1> <host 2> ... <host N>",
...
var createClientCertCmd = &cobra.Command{
	Use:   "create-client --certs-dir=<path to kwbase certs dir> --ca-key=<path-to-ca-key> <username>",
