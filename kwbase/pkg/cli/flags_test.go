...
//	defer leaktest.AfterTest(t)()
//	// Verify that the kwbase binary doesn't depend on certain packages.
//	buildutil.VerifyNoImports(t,
//		"gitee.com/kwbasedb/kwbase/pkg/cmd/kwbase", true,
//		[]string{
//			"testing",  // defines flags
//			"go/build", // probably not something we want in the main binary
//			"gitee.com/kwbasedb/kwbase/pkg/security/securitytest", // contains certificates
//			"gitee.com/kwbasedb/kwbase/pkg/replication/replicationproducer",
//			"gitee.com/kwbasedb/kwbase/pkg/cli",
//		},
//		[]string{
//			"gitee.com/kwbasedb/kwbase/pkg/testutils", // meant for testing code only
//		},
...
//		"gitee.com/kwbasedb/kwbase/vendor/github.com/getsentry/raven-go",
//		"gitee.com/kwbasedb/kwbase/vendor/github.com/cockroachdb/errors/withstack",
//	)
//}
	...
	for _, test := range testData {
		for _, cmdName := range test.cmds {
			t.Run(fmt.Sprintf("%s/%s", cmdName, strings.Join(test.flags, " ")), func(t *testing.T) {
				cmd, _, _ := kwbaseCmd.Find([]string{cmdName})
