...
var debugZipTablesPerCluster = []string{
	...
	"kwdb_internal.cluster_settings",
	"kwdb_internal.cluster_transactions",
...
var debugZipTablesPerNode = []string{
	"kwdb_internal.feature_usage",

	"kwdb_internal.gossip_alerts",
	"kwdb_internal.gossip_liveness",
	"kwdb_internal.gossip_network",
	"kwdb_internal.gossip_nodes",

	"kwdb_internal.leases",

	"kwdb_internal.node_build_info",
	"kwdb_internal.node_metrics",
	"kwdb_internal.node_queries",
	"kwdb_internal.node_runtime_info",
	"kwdb_internal.node_sessions",
	"kwdb_internal.node_statement_statistics",
	"kwdb_internal.node_transactions",
	"kwdb_internal.node_txn_stats",
}
...
func runDebugZip(cmd *cobra.Command, args []string) (retErr error) {
	...
	sqlConn, err := makeSQLClient("kwbase zip", useSystemDb)
	if err != nil {
