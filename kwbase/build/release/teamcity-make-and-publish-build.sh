...
curl -f -s -S -o- "https://${bucket}.s3.amazonaws.com/kwbase-${build_name}.linux-amd64.tgz" | tar ixfz - --strip-components 1
cp kwbase build/deploy/kwbase
...
tc_start_block "Push release tag to github.com/kwbasedb/kwbase"
...
tc_end_block "Push release tag to github.com/kwbasedb/kwbase"
...
if [[ -n "${is_custom_build}" ]] ; then
  ...
  push_to_git ssh://git@github.com/kwbasedb/kwbase.git --delete "${TC_BUILD_BRANCH}"
