...
run build/builder.sh make archive -Otarget ARCHIVE=build/kwbase.src.tgz &> artifacts/build-archive.log || (cat artifacts/build-archive.log && false)
...
run build/builder.sh rm build/kwbase.src.tgz
