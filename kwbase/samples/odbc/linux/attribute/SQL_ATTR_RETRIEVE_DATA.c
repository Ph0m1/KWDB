...
int main()
{
    ...
    // Set statement attribute for retrieve data
    SQLULEN retrieveData = SQL_RD_ON; // Enable retrieving data
    ret = SQLSetStmtAttr(hstmt, SQL_ATTR_RETRIEVE_DATA, (SQLPOINTER)retrieveData, 0);
    if (ret != SQL_SUCCESS && ret != SQL_SUCCESS_WITH_INFO)
    {
        printf("Error setting statement attribute for retrieving data\n");
    ...
    printf("set SQLSetStmtAttr(SQL_ATTR_RETRIEVE_DATA) successfully\n");
