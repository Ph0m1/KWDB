...
int main()
{
    ...
    // Set statement attribute for bookmark
    ret = SQLSetStmtAttr(hstmt, SQL_ATTR_FETCH_BOOKMARK_PTR, bookmark, MAX_BOOKMARK_SIZE);
    if (ret != SQL_SUCCESS && ret != SQL_SUCCESS_WITH_INFO)
    {
        printf("Error setting statement attribute for bookmark\n");
