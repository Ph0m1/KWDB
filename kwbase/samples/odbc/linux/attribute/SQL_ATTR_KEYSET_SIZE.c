...
int main()
{
    ...
    // Set statement attribute for keyset size
    SQLUINTEGER keysetSize = 10; // Set keyset size to 10
    ret = SQLSetStmtAttr(hstmt, SQL_ATTR_KEYSET_SIZE, (SQLPOINTER)keysetSize, 0);
    if (ret != SQL_SUCCESS && ret != SQL_SUCCESS_WITH_INFO)
    {
        printf("Error setting statement attribute for keyset size\n");
    ...
    printf("set SQLSetStmtAttr(SQL_ATTR_KEYSET_SIZE) successfully\n");
