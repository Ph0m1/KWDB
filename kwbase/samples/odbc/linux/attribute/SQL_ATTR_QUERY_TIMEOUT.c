...
int main()
{
    ...
    // Set statement attribute for query timeout
    SQLULEN queryTimeout = 30; // Set query timeout to 30 seconds
    ret = SQLSetStmtAttr(hstmt, SQL_ATTR_QUERY_TIMEOUT, (SQLPOINTER)queryTimeout, 0);
    if (ret != SQL_SUCCESS && ret != SQL_SUCCESS_WITH_INFO)
    {
        printf("Error setting statement attribute for query timeout\n");
    ...
    printf("set SQLSetStmtAttr(SQL_ATTR_QUERY_TIMEOUT) successfully\n");
