...
int main()
{
    ...
    // Set the SQL_DESC_CONCISE_TYPE field for the first column in the result set
    SQLLEN dataTypedesc;
    retcode = SQLColAttribute(hstmt, 1, SQL_DESC_CONCISE_TYPE, NULL, 0, NULL, &dataTypedesc);
    if (retcode == SQL_SUCCESS)
    {
        printf("Data type desc of the column: %d\n", dataTypedesc);
    }
    else
    {
