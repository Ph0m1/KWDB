...
int main()
{
    ...
    // Set the SQL_DESC_DISPLAY_SIZE field for the first column in the result set
    SQLLEN displaySize;
    // Get the display size of the first column
    retcode = SQLColAttribute(hstmt, 1, SQL_DESC_DISPLAY_SIZE, NULL, 0, NULL, &displaySize);
