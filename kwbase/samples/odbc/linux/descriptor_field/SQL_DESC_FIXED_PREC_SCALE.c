...
int main()
{
    ...
    // Set the SQL_DESC_FIXED_PREC_SCALE field for the first column in the result set
    SQLLEN scale;
    retcode = SQLColAttribute(hstmt, 1, SQL_DESC_FIXED_PREC_SCALE, NULL, 0, NULL, &scale);
