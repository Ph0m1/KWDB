...
int main()
{
    ...
    // Set the SQL_DESC_CASE_SENSITIVE field for the first column in the result set
    SQLLEN caseSensitive;
    // Get the case sensitivity attribute for the column
    retcode = SQLColAttribute(hstmt, 1, SQL_DESC_CASE_SENSITIVE, NULL, 0, NULL, &caseSensitive);
