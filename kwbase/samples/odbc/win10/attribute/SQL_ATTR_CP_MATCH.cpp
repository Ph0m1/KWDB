...
int main()
{
    ...
    retcode = SQLSetEnvAttr(envHandle, SQL_ATTR_CP_MATCH, (SQLPOINTER)SQL_CP_OFF, SQL_IS_UINTEGER);
    if (retcode != SQL_SUCCESS)
    {
        printf("Failed to set environment attribute for character set matching\n");
    }
    else
    {
        printf("Succeed to set environment attribute for character set matching\n");
    }
