...
int main()
{
    ...
    retcode = SQLSetConnectAttr(connHandle, SQL_ATTR_QUIET_MODE, (SQLPOINTER)&quietMode, SQL_IS_INTEGER);
    if (retcode == SQL_SUCCESS || retcode == SQL_SUCCESS_WITH_INFO)
    {
        printf("SQL_ATTR_QUIET_MODE set successfully to \n");
    }
    else
    {
        printf("SQL_ATTR_QUIET_MODE(SQL_ATTR_TRACEFILE) failed\n");
    }
