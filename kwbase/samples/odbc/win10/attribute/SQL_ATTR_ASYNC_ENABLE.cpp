...
int main()
{
    ...
    retcode = SQLSetStmtAttr(stmtHandle, SQL_ATTR_ASYNC_ENABLE, (SQLPOINTER)SQL_ASYNC_ENABLE_ON, 0);
    if (retcode != SQL_SUCCESS)
    {
        printf("Failed to enable asynchronous execution\n");
    }
    else
    {
        printf("Successed to enable asynchronous execution\n");
    }
