...
int main()
{
    ...
    retcode = SQLSetStmtAttr(stmtHandle, SQL_ATTR_PARAM_OPERATION_PTR, param_operations, 0);
    if (SQL_SUCCESS == retcode)
    {
        printf("SQL_ATTR_PARAM_OPERATION_PTR set to SQL_PARAM_BIND_BY_COLUMN successfully\n");
    }
