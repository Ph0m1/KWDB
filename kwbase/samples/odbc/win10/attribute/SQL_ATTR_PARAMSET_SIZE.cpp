...
int main()
{
    ...
    retcode = SQLSetStmtAttr(stmtHandle, SQL_ATTR_PARAMSET_SIZE, (SQLPOINTER)paramSetSize, 0);
    ...
    retcode = SQLGetStmtAttr(stmtHandle, SQL_ATTR_PARAMSET_SIZE, &retrievedParamSetSize, 0, NULL);
    if (retcode == SQL_SUCCESS)
    {
