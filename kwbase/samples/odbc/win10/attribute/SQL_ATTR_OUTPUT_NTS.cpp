...
int main()
{
    ...
    retcode = SQLSetEnvAttr(envHandle, SQL_ATTR_OUTPUT_NTS, (SQLPOINTER)SQL_TRUE, 0);
    if (retcode != SQL_SUCCESS)
    {
        printf("Failed to enable SQL_ATTR_OUTPUT_NTS for the environment\n");
    }
    else
    {
        printf("Successed to enable SQL_ATTR_OUTPUT_NTS for the environment\n");
    }
