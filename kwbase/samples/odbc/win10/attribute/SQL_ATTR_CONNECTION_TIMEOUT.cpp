...
int main()
{
    ...
    SQLCHAR bookmark[MAX_BOOKMARK_SIZE];
    SQLLEN bookmarkLen;
    retcode = SQLSetStmtAttr(stmtHandle, SQL_ATTR_FETCH_BOOKMARK_PTR, bookmark, MAX_BOOKMARK_SIZE);
    if (retcode != SQL_SUCCESS && retcode != SQL_SUCCESS_WITH_INFO)
    {
        return 1;
    }
    printf("set SQLSetStmtAttr(SQL_ATTR_FETCH_BOOKMARK_PTR) successfully\n");
