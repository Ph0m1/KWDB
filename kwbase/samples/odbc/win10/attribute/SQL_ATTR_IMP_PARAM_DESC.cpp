...
int main()
{
    ...
    SQLSMALLINT ParamType, DecimalDigits, Nullable;
    SQLULEN ParamSize;

    retcode = SQLPrepare(stmtHandle, (SQLWCHAR *)"INSERT INTO t12 VALUES (?)", SQL_NTS);
    retcode = SQLDescribeParam(stmtHandle, 1, &ParamType, &ParamSize, &DecimalDigits, &Nullable);
    if (retcode == SQL_SUCCESS || retcode == SQL_SUCCESS_WITH_INFO)
    {
        printf("Parameter 1 description successful.\n");
    ...
    {
        printf("Failed to describe parameter.\n");
    }
