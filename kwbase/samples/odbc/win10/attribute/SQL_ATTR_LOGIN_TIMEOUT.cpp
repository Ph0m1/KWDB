...
int main()
{
    ...
    SQLUINTEGER loginTimeout = 30; // Set login timeout to 30 seconds
    // Set SQL_ATTR_LOGIN_TIMEOUT
    retcode = SQLSetConnectAttr(connHandle, SQL_ATTR_LOGIN_TIMEOUT, (SQLPOINTER)loginTimeout, 0);
