...
int main()
{
    ...
    retcode = SQLSetStmtAttr(stmtHandle, SQL_ATTR_RETRIEVE_DATA, (SQLPOINTER)SQL_RD_ON, SQL_IS_UINTEGER);
    if (retcode != SQL_SUCCESS)
    {
        printf("Failed to set data retrieval mode to ON\n");
    }
    else
    {
        printf("Succeed to set data retrieval mode to ON\n");
    }
